                    ...
                    <div className="row g-0">
                      <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                        <div className="hero-02-static__caption loading__item">
                          <p className="t-large t-medium t-120 t-bright">Building iconic brands through strategy and design.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="marquee__toleft">
                        ...
                        {[...Array(3)].map((_, i) => (
                          <div key={i} className="marquee__item one-line item-regular text">
                            <p className="marquee__text">GRAPHIQ STUDIO LLC — Visual. Digital. Remarkable</p>
