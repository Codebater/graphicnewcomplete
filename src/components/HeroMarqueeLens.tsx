...
export default function HeroMarqueeLens() {
  useEffect(() => {
    ...
    const init = (): boolean => {
      ...
      // The clay character's HEAD is the lens: ball centre at (50.82%, 18%)
      // of the 830×1040 upper-body canvas, r = ball radius / width (173/830).
      // eyeCy = measured star-hole centroid line of the designer cutout
      // (left (328,160), right (478,154) -> y 157 / 1040).
      const HEAD = { cx: 0.5082, cy: 0.18, r: 0.2084, eyeCy: 0.151 };
