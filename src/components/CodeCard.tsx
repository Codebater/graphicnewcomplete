      ...
      <div className={styles.float}>
        <div className={styles.card} ref={cardRef}>
          ...
          <div className={styles.frame}>
            ...
            <img className={styles.portrait} src="/king/asad-real.webp" alt="Asad — The Code Genius" />
          ...
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img className={styles.hand} src="/king/midas-hand.webp" alt="" aria-hidden="true" />
          {/* eslint-disable-next-line @next/next/no-img-element */}
          ...
          <div className={styles.type}>
            <div className={styles.wordWrap}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img className={styles.word} src="/king/genius-word.webp" alt="GENIUS" />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img className={styles.codeTag} src="/king/code-word.webp" alt="CODE" />
            </div>
