...
// --------------------------------------------- //
       ...
       function changeEmoji() {
         if (emojiDisplay) {
           ...
           // Change emoji after a short delay
           setTimeout(() => {
             currentEmojiIndex = (currentEmojiIndex + 1) % emojis.length;
             emojiDisplay.src = emojis[currentEmojiIndex];
             
             // Remove changing animation class
             setTimeout(() => {
...
// Also change emoji on hover for interactivity
